<div>
    ...
    <div class="container m-auto mt-5 rounded-md">
        <div class="pt-10 px-10">
            <h1 class=" text-2xl font-bold">Registrar pabellon</h1>
        </div>
        <form wire:submit.prevent="submit" class="m-10 mt-0 p-4">
            ...
            <div>
                ...
                <select wire:model="calendar_id" wire:change="onChangeSelectCalendar"
            ...
            <x-textarea placeholder="Tipo" wire:model="tipe" class="mt-1 block w-full"/>
            @error('tipe')
                <p class="text-red-500 font-semibold my-2">
                    {{ $message }}
                </p>
