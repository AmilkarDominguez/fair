<div>
    ...
    <div class="container m-auto mt-5 rounded-md">
        <div class="pt-10 px-10">
            <h1 class=" text-2xl font-bold">Actualizar pabellon</h1>
        </div>
        <form wire:submit.prevent="submit" class="m-10 mt-0 p-4">
            ...
            <x-jet-input type="number" placeholder="Monto" wire:model="amount" class="mt-1 block w-full rounded-full"
                required />
            @error('amount')
                <p class="number-red-500 font-semibold my-2">
                    {{ $message }}
                </p>
            @enderror
            {{-- end amount --}}
