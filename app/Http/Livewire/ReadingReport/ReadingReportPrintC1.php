...
class ReadingReportPrintC1 extends Component
{
            ////////////////////
        // DATOS NECESARIOS
        ...
        // Datos de Tarifario CATEGORIA RESIDENCIAL(C-1)
        public $minimum_charge = 28.058; //carga minima
        // carga variable 1
        public $variable_one_rate = 1.376; public $variable_one = 20;
        // carga variable 2
        public $variable_two_rate = 1.456; public $variable_two = 100;
        // carga variable 3
