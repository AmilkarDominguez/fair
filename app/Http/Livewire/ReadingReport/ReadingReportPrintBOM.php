...
class ReadingReportPrintBOM extends Component
{
        ////////////////////
        // DATOS NECESARIOS
        ...
        // Datos de Tarifario CATEGORIA (BOM)
        public $minimum_charge = 46.884; //carga FIJO
        // carga variable 1
        public $variable_one_rate = 0.766; public $variable_one = 0;
        // carga variable 2
        public $variable_two_rate = 0; public $variable_two = 0;
        // carga variable 3
    ...
    public function calculo_BOM()
    {
        ...
        $this->amount_for_energy = $this->fixed_charge + $this->variable1; //importe por energia
        ...
        $this->amount_for_energy_print = $this->variable1; //importe por energia
