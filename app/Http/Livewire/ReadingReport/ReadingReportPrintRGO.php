...
class ReadingReportPrintRGO extends Component
{
                    ////////////////////
        // DATOS NECESARIOS
        ...
        // Datos de Tarifario CATEGORIA (RGO)
        public $minimum_charge = 46.884; //cargo FIJO
        // carga variable 1
        public $variable_one_rate = 0.766; public $variable_one = 0;
        // carga variable 2
        public $variable_two_rate = 0.843; public $variable_two = 300;
        // carga variable 3
