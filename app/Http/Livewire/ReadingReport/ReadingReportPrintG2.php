...
class ReadingReportPrintG2 extends Component
{
            ////////////////////
        // DATOS NECESARIOS
        ...
        // Datos de Tarifario CATEGORIA (G-2)
        public $minimum_charge = 23.868; //cargo FIJO
        // carga variable 1
        public $variable_one_rate = 1.599; public $variable_one = 0;
        // carga variable 2
        public $variable_two_rate = 1.565; public $variable_two = 40;
        // carga variable 3
