...
class ReadingReportPrintSEG extends Component
{
        ////////////////////
        // DATOS NECESARIOS
        ...
        // Datos de Tarifario CATEGORIA RESIDENCIAL(SEG)
        public $minimum_charge = 22.874; //carga minima
        // carga variable 1
        public $variable_one_rate = 0.562; public $variable_one = 20;
        // carga variable 2
        public $variable_two_rate = 0.981; public $variable_two = 120;
        // carga variable 3
        public $variable_three_rate = 1.323; public $variable_three = 300;
        // carga variable 4
    ...
    public function calculo_SEG()
    {
        ...
        $this->amount_for_energy = $this->fixed_charge + $this->variable1 + $this->variable2 + $this->variable3; //importe por energia
        ...
        $this->amount_for_energy_print = $this->variable1 + $this->variable2 + $this->variable3; //importe por energia
