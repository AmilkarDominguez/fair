...
class ReadingReportPrintINP extends Component
{
            ////////////////////
        // DATOS NECESARIOS
        ...
        // Datos de Tarifario CATEGORIA (INP)
        public $minimum_charge = 93.310; //carga minima
        // carga variable 1
        public $variable_one_rate = 0.736; public $variable_one = 100;
        // carga variable 2
        public $variable_two_rate = 0.891; public $variable_two = 300;
        // carga variable 3
